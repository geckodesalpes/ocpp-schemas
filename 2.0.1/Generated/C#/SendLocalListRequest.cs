...
//
//    using Ocpp._201.Generated.Models.SendLocalListRequest;
//
//    var sendLocalListRequest = SendLocalListRequest.FromJson(jsonString);

namespace Ocpp._201.Generated.Models.SendLocalListRequest
{
    using System;
    ...
    public partial class SendLocalListRequest
    {
        ...
        [JsonProperty("localAuthorizationList", NullValueHandling = NullValueHandling.Ignore)]
        public virtual System.Collections.Generic.List<AuthorizationData> LocalAuthorizationList { get; set; }

        [JsonProperty("updateType")]
        public virtual UpdateEnumType UpdateType { get; set; }
    ...
    public partial class AuthorizationData
    {
        ...
        [JsonProperty("idTokenInfo", NullValueHandling = NullValueHandling.Ignore)]
    ...
    /// </summary>
    public enum UpdateEnumType { Differential, Full };

    public partial class SendLocalListRequest
    {
        public static SendLocalListRequest FromJson(string json) => JsonConvert.DeserializeObject<SendLocalListRequest>(json, Ocpp._201.Generated.Models.SendLocalListRequest.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this SendLocalListRequest self) => JsonConvert.SerializeObject(self, Ocpp._201.Generated.Models.SendLocalListRequest.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                UpdateEnumTypeConverter.Singleton,
    ...
    internal class UpdateEnumTypeConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(UpdateEnumType) || t == typeof(UpdateEnumType?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "Differential":
                    return UpdateEnumType.Differential;
                case "Full":
                    return UpdateEnumType.Full;
            }
            throw new Exception("Cannot unmarshal type UpdateEnumType");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (UpdateEnumType)untypedValue;
            switch (value)
            {
                case UpdateEnumType.Differential:
                    serializer.Serialize(writer, "Differential");
                    return;
                case UpdateEnumType.Full:
                    serializer.Serialize(writer, "Full");
                    return;
            }
            throw new Exception("Cannot marshal type UpdateEnumType");
        }

        public static readonly UpdateEnumTypeConverter Singleton = new UpdateEnumTypeConverter();
    }
}
