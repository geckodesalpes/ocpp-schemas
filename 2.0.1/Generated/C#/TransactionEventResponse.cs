...
//
//    using Ocpp._201.Generated.Models.TransactionEventResponse;
//
//    var transactionEventResponse = TransactionEventResponse.FromJson(jsonString);

namespace Ocpp._201.Generated.Models.TransactionEventResponse
{
    using System;
    ...
    public partial class TransactionEventResponse
    {
        ...
        /// </summary>
        [JsonProperty("totalCost", NullValueHandling = NullValueHandling.Ignore)]
        public virtual double? TotalCost { get; set; }

        [JsonProperty("updatedPersonalMessage", NullValueHandling = NullValueHandling.Ignore)]
        public virtual MessageContentType UpdatedPersonalMessage { get; set; }
    }
    ...
    public partial class TransactionEventResponse
    {
        public static TransactionEventResponse FromJson(string json) => JsonConvert.DeserializeObject<TransactionEventResponse>(json, Ocpp._201.Generated.Models.TransactionEventResponse.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this TransactionEventResponse self) => JsonConvert.SerializeObject(self, Ocpp._201.Generated.Models.TransactionEventResponse.Converter.Settings);
    }
